...
(def lib 'com.sturdystats/bailey)
...
(defn jar
  ...
  (b/write-pom
   {:class-dir class-dir
    ...
    :src-dirs  ["src"]
    :pom-data
    [[:description "A small Clojure library for managing server-side encryption keys."]
     [:url "https://github.com/Sturdy-Statistics/bailey"]
     [:licenses
      [:license
     ...
     [:scm
      ...
      [:url "https://github.com/Sturdy-Statistics/bailey"]
      [:connection "scm:git:https://github.com/Sturdy-Statistics/bailey.git"]]]})
